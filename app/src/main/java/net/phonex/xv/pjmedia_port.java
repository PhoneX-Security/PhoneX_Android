...
public class pjmedia_port {
  ...
  public void setInfo(pjmedia_port_info value) {
    XviJNI.pjmedia_port_info_set(swigCPtr, this, pjmedia_port_info.getCPtr(value), value);
  }

  public pjmedia_port_info getInfo() {
    long cPtr = XviJNI.pjmedia_port_info_get(swigCPtr, this);
  ...
  public void setPut_frame(SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int value) {
    XviJNI.pjmedia_port_put_frame_set(swigCPtr, this, SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int getPut_frame() {
    long cPtr = XviJNI.pjmedia_port_put_frame_get(swigCPtr, this);
  ...
  public void setGet_frame(SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int value) {
    XviJNI.pjmedia_port_get_frame_set(swigCPtr, this, SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int getGet_frame() {
    long cPtr = XviJNI.pjmedia_port_get_frame_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_f_p_pjmedia_port_p_pjmedia_frame__int(cPtr, false);
  }

  public void setOn_destroy(SWIGTYPE_p_f_p_pjmedia_port__int value) {
    XviJNI.pjmedia_port_on_destroy_set(swigCPtr, this, SWIGTYPE_p_f_p_pjmedia_port__int.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_pjmedia_port__int getOn_destroy() {
    long cPtr = XviJNI.pjmedia_port_on_destroy_get(swigCPtr, this);
