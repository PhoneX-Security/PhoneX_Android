...
public enum pjsip_cred_data_type {
  PJSIP_CRED_DATA_PLAIN_PASSWD(XviJNI.PJSIP_CRED_DATA_PLAIN_PASSWD_get()),
  PJSIP_CRED_DATA_DIGEST(XviJNI.PJSIP_CRED_DATA_DIGEST_get()),
  PJSIP_CRED_DATA_EXT_AKA(XviJNI.PJSIP_CRED_DATA_EXT_AKA_get());
