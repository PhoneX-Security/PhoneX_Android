...
public enum pjsua_call_flag {
  PJSUA_CALL_UNHOLD(XviJNI.PJSUA_CALL_UNHOLD_get()),
  PJSUA_CALL_UPDATE_CONTACT(XviJNI.PJSUA_CALL_UPDATE_CONTACT_get()),
  PJSUA_CALL_INCLUDE_DISABLED_MEDIA(XviJNI.PJSUA_CALL_INCLUDE_DISABLED_MEDIA_get()),
  PJSUA_CALL_NO_SDP_OFFER(XviJNI.PJSUA_CALL_NO_SDP_OFFER_get());
