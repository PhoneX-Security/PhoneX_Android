...
public enum pjsua_destroy_flag {
  PJSUA_DESTROY_NO_RX_MSG(XviJNI.PJSUA_DESTROY_NO_RX_MSG_get()),
  PJSUA_DESTROY_NO_TX_MSG(XviJNI.PJSUA_DESTROY_NO_TX_MSG_get()),
  PJSUA_DESTROY_NO_NETWORK(XviJNI.PJSUA_DESTROY_NO_NETWORK_get());
