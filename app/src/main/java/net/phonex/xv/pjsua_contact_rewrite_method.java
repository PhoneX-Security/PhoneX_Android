...
public enum pjsua_contact_rewrite_method {
  PJSUA_CONTACT_REWRITE_UNREGISTER(XviJNI.PJSUA_CONTACT_REWRITE_UNREGISTER_get()),
  PJSUA_CONTACT_REWRITE_NO_UNREG(XviJNI.PJSUA_CONTACT_REWRITE_NO_UNREG_get()),
  PJSUA_CONTACT_REWRITE_ALWAYS_UPDATE(XviJNI.PJSUA_CONTACT_REWRITE_ALWAYS_UPDATE_get());
