...
public class pj_str_t {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        XviJNI.delete_pj_str_t(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setPtr(String value) {
    XviJNI.pj_str_t_ptr_set(swigCPtr, this, value);
  }

  public String getPtr() {
    return XviJNI.pj_str_t_ptr_get(swigCPtr, this);
  }

  public void setSlen(int value) {
    XviJNI.pj_str_t_slen_set(swigCPtr, this, value);
  }

  public int getSlen() {
    return XviJNI.pj_str_t_slen_get(swigCPtr, this);
  }

  public pj_str_t() {
    this(XviJNI.new_pj_str_t(), true);
  }
