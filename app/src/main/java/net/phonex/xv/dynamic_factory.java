...
public class dynamic_factory {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        XviJNI.delete_dynamic_factory(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setShared_lib_path(pj_str_t value) {
    XviJNI.dynamic_factory_shared_lib_path_set(swigCPtr, this, pj_str_t.getCPtr(value), value);
  }

  public pj_str_t getShared_lib_path() {
    long cPtr = XviJNI.dynamic_factory_shared_lib_path_get(swigCPtr, this);
    return (cPtr == 0) ? null : new pj_str_t(cPtr, false);
  }

  public void setInit_factory_name(pj_str_t value) {
    XviJNI.dynamic_factory_init_factory_name_set(swigCPtr, this, pj_str_t.getCPtr(value), value);
  }

  public pj_str_t getInit_factory_name() {
    long cPtr = XviJNI.dynamic_factory_init_factory_name_get(swigCPtr, this);
    return (cPtr == 0) ? null : new pj_str_t(cPtr, false);
  }

  public dynamic_factory() {
    this(XviJNI.new_dynamic_factory(), true);
  }
