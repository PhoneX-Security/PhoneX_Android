...
public class pjsua_mwi_info {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        XviJNI.delete_pjsua_mwi_info(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setEvsub(SWIGTYPE_p_pjsip_evsub value) {
    XviJNI.pjsua_mwi_info_evsub_set(swigCPtr, this, SWIGTYPE_p_pjsip_evsub.getCPtr(value));
  }

  public SWIGTYPE_p_pjsip_evsub getEvsub() {
    long cPtr = XviJNI.pjsua_mwi_info_evsub_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_pjsip_evsub(cPtr, false);
  }

  public void setRdata(SWIGTYPE_p_pjsip_rx_data value) {
    XviJNI.pjsua_mwi_info_rdata_set(swigCPtr, this, SWIGTYPE_p_pjsip_rx_data.getCPtr(value));
  }

  public SWIGTYPE_p_pjsip_rx_data getRdata() {
    long cPtr = XviJNI.pjsua_mwi_info_rdata_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_pjsip_rx_data(cPtr, false);
  }

  public pjsua_mwi_info() {
    this(XviJNI.new_pjsua_mwi_info(), true);
  }
