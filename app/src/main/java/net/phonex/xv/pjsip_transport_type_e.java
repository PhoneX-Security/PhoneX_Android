...
public enum pjsip_transport_type_e {
  ...
  PJSIP_TRANSPORT_IPV6(XviJNI.PJSIP_TRANSPORT_IPV6_get()),
  PJSIP_TRANSPORT_UDP6(XviJNI.PJSIP_TRANSPORT_UDP6_get()),
  PJSIP_TRANSPORT_TCP6(XviJNI.PJSIP_TRANSPORT_TCP6_get()),
  PJSIP_TRANSPORT_TLS6(XviJNI.PJSIP_TRANSPORT_TLS6_get());
