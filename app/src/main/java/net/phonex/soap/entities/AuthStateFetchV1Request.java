...
public class AuthStateFetchV1Request implements KvmSerializable, SoapEnvelopeRegisterable {
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            ...
            case 1:
                // type: java.lang.String
                this.userName = (java.lang.String)arg1;
                break;
            case 2:
                // type: java.lang.String
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "authStateFetchV1Request", net.phonex.soap.entities.AuthStateFetchV1Request.class); // root
    } 

    @Override
    public String toString() {
        return "AuthStateFetchV1Request{"+"nonce=" + this.nonce+", userName=" + this.userName+", auxJSON=" + this.auxJSON + '}';
    }
}
