...
public class ScryptUtil {
     ...
     * @throws IOException 
     */
    public static boolean check(String passwd, String hashed) throws IOException {
        try {
            ...
            byte[] salt = Base64.decode(parts[3].getBytes());
            byte[] derived0 = Base64.decode(parts[4].getBytes());
