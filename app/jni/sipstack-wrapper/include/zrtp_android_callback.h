...
public:
    ...
    virtual void on_zrtp_update_state (pjsua_call_id call_id, int hcode, int zrtp_state, int sev, int subcode) {}
    virtual void on_zrtp_hash_match (pjsua_call_id call_id, int matchResult) {}
    virtual void on_zrtp_secure_state (pjsua_call_id call_id, int secure_state_on) {}
};
