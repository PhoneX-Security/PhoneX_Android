...
LOCAL_STATIC_LIBRARIES += libgcc libcutils
LOCAL_SHARED_LIBRARIES += libdl libcutils liblog libgccdemangle cutils
LOCAL_LDLIBS += -llog -ldl

LOCAL_CFLAGS += -std=gnu99 -Werror -DNOTGKILL
LOCAL_MODULE := liblocalcorkscrew
...
#LOCAL_SHARED_LIBRARIES := liblocalcorkscrew
#LOCAL_MODULE := liblocalcorkscrew_test
#LOCAL_MODULE_TAGS := optional
...
LOCAL_CFLAGS += -DCORKSCREW_HAVE_ARCH
LOCAL_STATIC_LIBRARIES += libcutils liblog cutils
LOCAL_LDLIBS += -ldl
ifeq ($(HOST_OS),linux)
