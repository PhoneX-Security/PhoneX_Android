...
# We depends on sipstack at this point because we need service to be stored somewhere
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../android_sources/pjmedia/include/pjmedia-videodev \
	$(LOCAL_PATH)/../../../swig-glue \
	$(LOCAL_PATH)/../../../sipstack-wrapper/include
...
LOCAL_SHARED_LIBRARIES += libsipstackjni
