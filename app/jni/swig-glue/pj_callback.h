...
public:
	...
	virtual void on_reg_started2 (pjsua_acc_id acc_id, pjsua_reg_info *info) {}
...
//#endif
	...
	virtual void on_snd_dev_operation(int operation) {}
	virtual void on_call_media_event(pjsua_call_id call_id, unsigned med_idx, pjmedia_event *event) {}
	virtual void on_reregistration_compute_backoff(pjsua_acc_id acc_id, pj_reg_backoff_struct * backoff_struct) {}
