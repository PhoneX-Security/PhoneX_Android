...
SWIG_GLUE_NATIVE_FILE := xvi_wrap.cpp
JAVA_MODULE := Xvi
JAVA_PACKAGE := net.phonex.xv
JAVA_PACKAGE_DIR := src/$(subst .,/,$(JAVA_PACKAGE))

PJ_ROOT_DIR := $(SWIG_GLUE_PATH)/../pjsip/sources
CSS_WRAPPER_ROOT_DIR := $(SWIG_GLUE_PATH)/../sipstack-wrapper
MOD_REGHANDLER_ROOT_DIR := $(SWIG_GLUE_PATH)/../pjsip_mod_reghandler
MOD_SIGN_ROOT_DIR := $(SWIG_GLUE_PATH)/../pjsip_mod_sign
MOD_CRASH := $(SWIG_GLUE_PATH)/../crash
...
PJ_SWIG_HEADERS += $(CSS_WRAPPER_ROOT_DIR)/include/pjsua_jni_addons.h \
	...
	$(CSS_WRAPPER_ROOT_DIR)/include/sipstack_codecs_utils.h  \
	$(MOD_REGHANDLER_ROOT_DIR)/include/pjsip_mobile_reg_handler.h \
	$(MOD_SIGN_ROOT_DIR)/include/pjsip_sign.h 
	
#	$(MOD_CRASH)/include/NCH.h \
#	$(MOD_CRASH)/include/NativeCrashHandler.h \
...
INTERFACES_FILES := $(SWIG_GLUE_PATH)/generic_java.i \
					...
					$(CSS_WRAPPER_ROOT_DIR)/include/sipstack-wrapper.i \
					$(MOD_REGHANDLER_ROOT_DIR)/include/mod_reghandler.i \
					$(MOD_SIGN_ROOT_DIR)/include/mod_sign.i \
					$(CONCAT_PJSUA_FILE)
					
#$(MOD_CRASH)/include/NativeCrashHandler.i \
...
LOCAL_C_INCLUDES += $(MOD_SIGN_ROOT_DIR)/include
#LOCAL_C_INCLUDES += $(MOD_CRASH)/include
