...
public class GeneralResponse implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 3:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       net.phonex.util.Log.ef("GeneralResponse", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   net.phonex.util.Log.e("GeneralResponse", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "generalResponse", GeneralResponse.class); // root
    } 

    @Override
    public String toString() {
        return "GeneralResponse{"+"errCode=" + this.errCode+", errText=" + this.errText+", responseJSON=" + this.responseJSON+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
