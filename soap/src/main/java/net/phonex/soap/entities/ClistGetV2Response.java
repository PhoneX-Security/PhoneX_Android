...
public class ClistGetV2Response implements KvmSerializable, SoapEnvelopeRegisterable {
    ...
    protected ClistElementListV2 contactList;
     ...
     * @return
     *     possible object is
     *     {@link ClistElementListV2 }
     *     
     */
    public ClistElementListV2 getContactList() {
        return contactList;
    }
     ...
     *     
     */
    public void setContactList(ClistElementListV2 value) {
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
        ...
        switch (index){
            ...
            case 3:
                ...
                break;
            case 4:
                // type: com.phoenix.soap.beans.ClistElementListV2
                info.name = "contactList";
                info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE);
                info.type = ClistElementListV2.class;
                break;
            default:
                break;
        }
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            case 0:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("ClistGetV2Response", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("ClistGetV2Response", "Problem with version parsing - unknown type");
               }
            ...
            case 1:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("ClistGetV2Response", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("ClistGetV2Response", "Problem with auxVersion parsing - unknown type");
               }
            ...
            case 4:
                // type: com.phoenix.soap.beans.ClistElementListV2
                this.contactList = (ClistElementListV2)arg1;
                break;
            default:
                return;
        }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "clistGetV2Response", net.phonex.soap.entities.ClistGetV2Response.class); // root
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "contactList", ClistElementListV2.class); // same package
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ClistElementListV2", ClistElementListV2.class); // package i class
        new ClistElementListV2().register(soapEnvelope); // registerable
    } 

    @Override
    public String toString() {
        return "ClistGetV2Response{"+"version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON+", errCode=" + this.errCode+", contactList=" + this.contactList + '}';
    }
}
