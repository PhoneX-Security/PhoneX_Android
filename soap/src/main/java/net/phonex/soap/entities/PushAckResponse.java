...
public class PushAckResponse implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PushAckResponse", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PushAckResponse", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "pushAckResponse", net.phonex.soap.entities.PushAckResponse.class); // root
    } 

    @Override
    public String toString() {
        return "PushAckResponse{"+"errCode=" + this.errCode+", responseJSON=" + this.responseJSON+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
