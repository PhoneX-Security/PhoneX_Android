...
public class AccountingSaveResponse implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 3:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       net.phonex.util.Log.ef("AccountingSaveResponse", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   net.phonex.util.Log.e("AccountingSaveResponse", "Problem with version parsing - unknown type");
               }
            ...
            case 4:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       net.phonex.util.Log.ef("AccountingSaveResponse", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   net.phonex.util.Log.e("AccountingSaveResponse", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "accountingSaveResponse", AccountingSaveResponse.class); // root
    } 

    @Override
    public String toString() {
        return "AccountingSaveResponse{"+"errCode=" + this.errCode+", errText=" + this.errText+", responseBody=" + this.responseBody+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
