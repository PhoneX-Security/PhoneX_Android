...
public class CgroupList extends Vector<net.phonex.soap.entities.Cgroup> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void setProperty(int index, Object value) { 
        this.add((net.phonex.soap.entities.Cgroup) value); 
    } 

    @Override 
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) { 
        info.name = "groups"; 
        info.type = net.phonex.soap.entities.Cgroup.class; 
        info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE); 
    } 

    @Override 
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "Cgroup", net.phonex.soap.entities.Cgroup.class);
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "groups", net.phonex.soap.entities.Cgroup.class);
        new Cgroup().register(soapEnvelope);
    }
}
