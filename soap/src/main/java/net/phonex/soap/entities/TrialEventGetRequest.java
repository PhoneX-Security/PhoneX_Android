...
public class TrialEventGetRequest implements KvmSerializable, SoapEnvelopeRegisterable {

    public final static String NAMESPACE = "http://phoenix.com/hr/schemas";
    protected boolean ignoreNullWrappers = false;
    protected java.lang.Integer etype;
     ...
     *     
     */
    public void setEtype(java.lang.Integer value) {
        this.etype = value;
    }
    /**
        ...
        switch (index){
            case 0:
               ...
               if (arg1 instanceof Integer) {
                   this.etype = (java.lang.Integer) arg1;
               } else if (arg1 instanceof java.lang.String) {
                   final String tmpArg1 = (String) arg1;
                   try {
                       this.etype = Integer.parseInt(tmpArg1);
                   } catch (Exception e) {
                       Log.ef("TrialEventGetRequest", e, "Problem with etype parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("TrialEventGetRequest", "Problem with etype parsing - unknown type");
               }
            ...
            case 1:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("TrialEventGetRequest", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("TrialEventGetRequest", "Problem with version parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("TrialEventGetRequest", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("TrialEventGetRequest", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "trialEventGetRequest", net.phonex.soap.entities.TrialEventGetRequest.class); // root
    } 

    @Override
    public String toString() {
        return "TrialEventGetRequest{"+"etype=" + this.etype+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
