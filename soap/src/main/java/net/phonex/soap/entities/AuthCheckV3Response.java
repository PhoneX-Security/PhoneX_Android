...
public class AuthCheckV3Response implements KvmSerializable, SoapEnvelopeRegisterable {

    public final static String NAMESPACE = "http://phoenix.com/hr/schemas";
    protected boolean ignoreNullWrappers = false;
    protected net.phonex.soap.entities.TrueFalse authHashValid;
    protected net.phonex.soap.entities.TrueFalseNA certValid;
    protected net.phonex.soap.entities.CertificateStatus certStatus;
    ...
    /**
     * Gets the value of the authHashValid property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public net.phonex.soap.entities.TrueFalse getAuthHashValid() {
        return authHashValid;
    }

    /**
     * Sets the value of the authHashValid property.
     * 
     * @param value
     *     allowed object is
     *     {@link net.phonex.soap.entities.TrueFalse }
     *     
     */
    public void setAuthHashValid(net.phonex.soap.entities.TrueFalse value) {
        this.authHashValid = value;
    }
    /**
     ...
     * @return
     *     possible object is
     *     {@link net.phonex.soap.entities.TrueFalseNA }
     *     
     */
    public net.phonex.soap.entities.TrueFalseNA getCertValid() {
        return certValid;
    }
     ...
     *     
     */
    public void setCertValid(net.phonex.soap.entities.TrueFalseNA value) {
     ...
     *     
     */
    public net.phonex.soap.entities.CertificateStatus getCertStatus() {
        return certStatus;
    }
     ...
     *     
     */
    public void setCertStatus(net.phonex.soap.entities.CertificateStatus value) {
    ...
    public Object getProperty(int index) {
        ...
        switch (index){
            case 0:
                return this.authHashValid == null ? null : this.authHashValid.toString().toLowerCase();
            case 1:
                return this.certValid == null ? null : this.certValid.toString().toLowerCase();
            case 2:
                return this.certStatus == null ? null : this.certStatus.toString().toLowerCase();
            case 3:
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            case 0:
                // type: com.phoenix.soap.beans.TrueFalse
                this.authHashValid = net.phonex.soap.entities.TrueFalse.fromValue((String) arg1);
                break;
            case 1:
                // type: com.phoenix.soap.beans.TrueFalseNA
                this.certValid = net.phonex.soap.entities.TrueFalseNA.fromValue((String) arg1);
                break;
            case 2:
                // type: com.phoenix.soap.beans.CertificateStatus
                this.certStatus = net.phonex.soap.entities.CertificateStatus.fromValue((String) arg1);
                break;
            case 3:
                // type: com.phoenix.soap.beans.TrueFalse
            ...
            case 5:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("AuthCheckV3Response", e, "Problem with storedFilesNum parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.ef("AuthCheckV3Response", "Problem with storedFilesNum parsing - unknown type");
               }
                ...
                if (arg1 instanceof java.util.Calendar) {
                    ...
                    if (str1_serverTime==null || str1_serverTime.length()==0){ 
                        ...
                        try { 
                            ...
                            Log.ef("AuthCheckV3Response", "Problem with date parsing", e);
                        } 
                    } 
                } 
                ...
                if (arg1 instanceof java.util.Calendar) {
                    ...
                    if (str1_accountIssued==null || str1_accountIssued.length()==0){ 
                        ...
                        try { 
                            ...
                            Log.e("AuthCheckV3Response", "Problem with date parsing", e);
                        } 
                    } 
                } 
            ...
            case 16:
               ...
               if (arg1 instanceof Boolean) {
                   ...
                   try {
                       ...
                       Log.ef("AuthCheckV3Response", e, "Problem with accountDisabled parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("AuthCheckV3Response", "Problem with accountDisabled parsing - unknown type");
               }
            ...
            case 17:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("AuthCheckV3Response", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("AuthCheckV3Response", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "authCheckV3Response", net.phonex.soap.entities.AuthCheckV3Response.class); // root
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "certStatus", net.phonex.soap.entities.CertificateStatus.class); // same package
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "certValid", net.phonex.soap.entities.TrueFalseNA.class); // same package
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "authHashValid", net.phonex.soap.entities.TrueFalse.class); // same package
    } 

    @Override
    public String toString() {
        return "AuthCheckV3Response{"+"authHashValid=" + this.authHashValid+", certValid=" + this.certValid+", certStatus=" + this.certStatus+", forcePasswordChange=" + this.forcePasswordChange+", errCode=" + this.errCode+", storedFilesNum=" + this.storedFilesNum+", serverTime=" + this.serverTime+", licenseType=" + this.licenseType+", accountIssued=" + this.accountIssued+", accountExpires=" + this.accountExpires+", firstAuthCheckDate=" + this.firstAuthCheckDate+", lastAuthCheckDate=" + this.lastAuthCheckDate+", firstLoginDate=" + this.firstLoginDate+", firstUserAddDate=" + this.firstUserAddDate+", accountLastActivity=" + this.accountLastActivity+", accountLastPassChange=" + this.accountLastPassChange+", accountDisabled=" + this.accountDisabled+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
