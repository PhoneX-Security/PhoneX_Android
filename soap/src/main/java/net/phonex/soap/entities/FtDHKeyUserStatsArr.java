...
public class FtDHKeyUserStatsArr extends Vector<net.phonex.soap.entities.FtDHKeyUserStats> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void setProperty(int index, Object value) { 
        this.add((net.phonex.soap.entities.FtDHKeyUserStats) value); 
    } 

    @Override 
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) { 
        info.name = "keystats"; 
        info.type = net.phonex.soap.entities.FtDHKeyUserStats.class; 
        info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE); 
    } 

    @Override 
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "FtDHKeyUserStats", net.phonex.soap.entities.FtDHKeyUserStats.class);
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "keystats", net.phonex.soap.entities.FtDHKeyUserStats.class);
        new FtDHKeyUserStats().register(soapEnvelope);
    }
}
