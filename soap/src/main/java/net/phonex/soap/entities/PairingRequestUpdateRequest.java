...
public class PairingRequestUpdateRequest implements KvmSerializable, SoapEnvelopeRegisterable {

    public final static String NAMESPACE = "http://phoenix.com/hr/schemas";
    protected boolean ignoreNullWrappers = false;
    protected net.phonex.soap.entities.PairingRequestUpdateList updateList;
     ...
     * @return
     *     possible object is
     *     {@link net.phonex.soap.entities.PairingRequestUpdateList }
     *     
     */
    public net.phonex.soap.entities.PairingRequestUpdateList getUpdateList() {
        return updateList;
    }
     ...
     *     
     */
    public void setUpdateList(net.phonex.soap.entities.PairingRequestUpdateList value) {
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
        ...
        switch (index){
            case 0:
                // type: com.phoenix.soap.beans.PairingRequestUpdateList
                info.name = "updateList";
                info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE);
                info.type = net.phonex.soap.entities.PairingRequestUpdateList.class;
                break;
            case 1:
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            case 0:
                // type: com.phoenix.soap.beans.PairingRequestUpdateList
                this.updateList = (net.phonex.soap.entities.PairingRequestUpdateList)arg1;
                break;
            case 1:
                // type: java.lang.Integer
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PairingRequestUpdateRequest", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PairingRequestUpdateRequest", "Problem with version parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PairingRequestUpdateRequest", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PairingRequestUpdateRequest", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "pairingRequestUpdateRequest", net.phonex.soap.entities.PairingRequestUpdateRequest.class); // root
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "updateList", net.phonex.soap.entities.PairingRequestUpdateList.class); // same package
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "PairingRequestUpdateList", net.phonex.soap.entities.PairingRequestUpdateList.class); // package i class
        new net.phonex.soap.entities.PairingRequestUpdateList().register(soapEnvelope); // registerable 
    } 

    @Override
    public String toString() {
        return "PairingRequestUpdateRequest{"+"updateList=" + this.updateList+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
