...
public class FtRemoveDHKeysResponse implements KvmSerializable, SoapEnvelopeRegisterable {
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ftRemoveDHKeysResponse", net.phonex.soap.entities.FtRemoveDHKeysResponse.class); // root
    } 

    @Override
    public String toString() {
        return "FtRemoveDHKeysResponse{"+"errCode=" + this.errCode + '}';
    }
}
