...
public class ClistChangeResultListV2 extends Vector<net.phonex.soap.entities.ClistChangeResultV2> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void setProperty(int index, Object value) { 
        this.add((net.phonex.soap.entities.ClistChangeResultV2) value); 
    } 

    @Override 
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) { 
        info.name = "results"; 
        info.type = net.phonex.soap.entities.ClistChangeResultV2.class; 
        info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE); 
    } 

    @Override 
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ClistChangeResultV2", net.phonex.soap.entities.ClistChangeResultV2.class);
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "results", net.phonex.soap.entities.ClistChangeResultV2.class);
        new ClistChangeResultV2().register(soapEnvelope);
    }
}
