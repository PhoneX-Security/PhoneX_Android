...
public class AccountInfoV1Request implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 1:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("AccountInfoV1Request", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("AccountInfoV1Request", "Problem with version parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("AccountInfoV1Request", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("AccountInfoV1Request", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "accountInfoV1Request", net.phonex.soap.entities.AccountInfoV1Request.class); // root
    } 

    @Override
    public String toString() {
        return "AccountInfoV1Request{"+"targetUser=" + this.targetUser+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
