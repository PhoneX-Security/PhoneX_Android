...
public class PairingRequestUpdateResultList extends Vector<java.lang.Integer> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "errCodes", java.lang.Integer.class, new net.phonex.soap.marshallers.MarshalInteger());
    }
}
