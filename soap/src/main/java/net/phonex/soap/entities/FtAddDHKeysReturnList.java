...
public class FtAddDHKeysReturnList extends Vector<java.lang.Integer> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "code", java.lang.Integer.class, new net.phonex.soap.marshallers.MarshalInteger());
    }
}
