...
public class PushRequestRequest implements KvmSerializable, SoapEnvelopeRegisterable {

    public final static String NAMESPACE = "http://phoenix.com/hr/schemas";
    protected boolean ignoreNullWrappers = false;
    protected java.lang.String reqJSON;
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            case 0:
                // type: java.lang.String
                this.reqJSON = (java.lang.String)arg1;
                break;
            case 1:
                // type: java.lang.Integer
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PushRequestRequest", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PushRequestRequest", "Problem with version parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PushRequestRequest", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PushRequestRequest", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "pushRequestRequest", net.phonex.soap.entities.PushRequestRequest.class); // root
    } 

    @Override
    public String toString() {
        return "PushRequestRequest{"+"reqJSON=" + this.reqJSON+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
