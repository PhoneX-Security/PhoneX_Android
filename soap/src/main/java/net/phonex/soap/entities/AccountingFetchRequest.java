...
public class AccountingFetchRequest implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 1:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       net.phonex.util.Log.ef("AccountingFetchRequest", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   net.phonex.util.Log.e("AccountingFetchRequest", "Problem with version parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       net.phonex.util.Log.ef("AccountingFetchRequest", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   net.phonex.util.Log.e("AccountingFetchRequest", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "accountingFetchRequest", AccountingFetchRequest.class); // root
    } 

    @Override
    public String toString() {
        return "AccountingFetchRequest{"+"requestBody=" + this.requestBody+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
