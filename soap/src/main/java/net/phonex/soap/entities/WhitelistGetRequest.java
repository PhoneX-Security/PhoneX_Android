...
public class WhitelistGetRequest implements KvmSerializable, SoapEnvelopeRegisterable {
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "whitelistGetRequest", net.phonex.soap.entities.WhitelistGetRequest.class); // root
    } 

    @Override
    public String toString() {
        return "WhitelistGetRequest{" + '}';
    }
}
