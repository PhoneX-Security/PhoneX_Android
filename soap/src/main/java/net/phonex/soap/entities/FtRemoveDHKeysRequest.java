...
public class FtRemoveDHKeysRequest implements KvmSerializable, SoapEnvelopeRegisterable {
    ...
    protected net.phonex.soap.entities.SipDatePairList userDateList;
    ...
    /**
     * Gets the value of the userDateList property.
     * 
     * @return
     *     possible object is
     *     {@link net.phonex.soap.entities.SipDatePairList }
     *     
     */
    public net.phonex.soap.entities.SipDatePairList getUserDateList() {
        return userDateList;
    }

    /**
     * Sets the value of the userDateList property.
     * 
     * @param value
     *     allowed object is
     *     {@link net.phonex.soap.entities.SipDatePairList }
     *     
     */
    public void setUserDateList(net.phonex.soap.entities.SipDatePairList value) {
        this.userDateList = value;
    }
    /**
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
        ...
        switch (index){
            ...
            case 2:
                ...
                break;
            case 3:
                // type: com.phoenix.soap.beans.SipDatePairList
                info.name = "userDateList";
                info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE);
                info.type = net.phonex.soap.entities.SipDatePairList.class;
                break;
            case 4:
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            ...
            case 3:
                // type: com.phoenix.soap.beans.SipDatePairList
                this.userDateList = (net.phonex.soap.entities.SipDatePairList)arg1;
                break;
            case 4:
                // type: javax.xml.datatype.XMLGregorianCalendar
                if (arg1 instanceof java.util.Calendar) {
                    ...
                    if (str1_deleteOlderThan==null || str1_deleteOlderThan.length()==0){ 
                        ...
                        try { 
                            ...
                            Log.e("FtRemoveDHKeysRequest", "Problem with date parsing", e);
                        } 
                    } 
                } 
            ...
            case 5:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("FtRemoveDHKeysRequest", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("FtRemoveDHKeysRequest", "Problem with version parsing - unknown type");
               }
            ...
            case 6:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("FtRemoveDHKeysRequest", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("FtRemoveDHKeysRequest", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ftRemoveDHKeysRequest", net.phonex.soap.entities.FtRemoveDHKeysRequest.class); // root
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "userDateList", net.phonex.soap.entities.SipDatePairList.class); // same package
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "SipDatePairList", net.phonex.soap.entities.SipDatePairList.class); // package i class
        new net.phonex.soap.entities.SipDatePairList().register(soapEnvelope); // registerable 
    } 

    @Override
    public String toString() {
        return "FtRemoveDHKeysRequest{"+"deleteAll=" + this.deleteAll+", nonceList=" + this.nonceList+", users=" + this.users+", userDateList=" + this.userDateList+", deleteOlderThan=" + this.deleteOlderThan+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
