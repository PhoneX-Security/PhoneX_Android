...
public class PairingRequestUpdateResponse implements KvmSerializable, SoapEnvelopeRegisterable {

    public final static String NAMESPACE = "http://phoenix.com/hr/schemas";
    protected boolean ignoreNullWrappers = false;
    protected int errCode;
    protected net.phonex.soap.entities.PairingRequestUpdateResultList resultList;
     ...
     * @return
     *     possible object is
     *     {@link net.phonex.soap.entities.PairingRequestUpdateResultList }
     *     
     */
    public net.phonex.soap.entities.PairingRequestUpdateResultList getResultList() {
        return resultList;
    }
     ...
     *     
     */
    public void setResultList(net.phonex.soap.entities.PairingRequestUpdateResultList value) {
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
        ...
        switch (index){
            case 0:
                ...
                break;
            case 1:
                // type: com.phoenix.soap.beans.PairingRequestUpdateResultList
                info.name = "resultList";
                info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE);
                info.type = net.phonex.soap.entities.PairingRequestUpdateResultList.class;
                break;
            case 2:
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            ...
            case 1:
                // type: com.phoenix.soap.beans.PairingRequestUpdateResultList
                this.resultList = (net.phonex.soap.entities.PairingRequestUpdateResultList)arg1;
                break;
            case 2:
                // type: java.lang.Integer
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PairingRequestUpdateResponse", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PairingRequestUpdateResponse", "Problem with version parsing - unknown type");
               }
            ...
            case 3:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PairingRequestUpdateResponse", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PairingRequestUpdateResponse", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "pairingRequestUpdateResponse", net.phonex.soap.entities.PairingRequestUpdateResponse.class); // root
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "resultList", net.phonex.soap.entities.PairingRequestUpdateResultList.class); // same package
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "PairingRequestUpdateResultList", net.phonex.soap.entities.PairingRequestUpdateResultList.class); // package i class
        new net.phonex.soap.entities.PairingRequestUpdateResultList().register(soapEnvelope); // registerable 
    } 

    @Override
    public String toString() {
        return "PairingRequestUpdateResponse{"+"errCode=" + this.errCode+", resultList=" + this.resultList+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
