...
public class TrialEventSaveResponse implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 1:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("TrialEventSaveResponse", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("TrialEventSaveResponse", "Problem with version parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("TrialEventSaveResponse", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("TrialEventSaveResponse", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "trialEventSaveResponse", net.phonex.soap.entities.TrialEventSaveResponse.class); // root
    } 

    @Override
    public String toString() {
        return "TrialEventSaveResponse{"+"errCode=" + this.errCode+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
