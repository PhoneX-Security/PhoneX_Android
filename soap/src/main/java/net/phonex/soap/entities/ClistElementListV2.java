...
public class ClistElementListV2 extends Vector<ClistElementV2> implements KvmSerializable, SoapEnvelopeRegisterable {
    ...
    public void setProperty(int index, Object value) { 
        this.add((ClistElementV2) value);
    } 

    @Override 
    public void getPropertyInfo(int index, Hashtable properties, PropertyInfo info) { 
        info.name = "elements"; 
        info.type = ClistElementV2.class;
        info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE); 
    } 

    @Override 
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ClistElementV2", ClistElementV2.class);
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "elements", ClistElementV2.class);
        new ClistElementV2().register(soapEnvelope);
    }
}
