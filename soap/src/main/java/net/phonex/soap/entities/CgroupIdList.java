...
public class CgroupIdList extends Vector<java.lang.Long> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "Long", java.lang.Long.class, new net.phonex.soap.marshallers.MarshalLong());
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ids", java.lang.Long.class, new net.phonex.soap.marshallers.MarshalLong());
    }
}
