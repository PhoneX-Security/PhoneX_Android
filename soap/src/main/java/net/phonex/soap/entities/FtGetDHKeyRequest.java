...
public class FtGetDHKeyRequest implements KvmSerializable, SoapEnvelopeRegisterable {
            ...
            case 1:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("FtGetDHKeyRequest", e, "Problem with protocolVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("FtGetDHKeyRequest", "Problem with protocolVersion parsing - unknown type");
               }
            ...
            case 2:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("FtGetDHKeyRequest", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("FtGetDHKeyRequest", "Problem with version parsing - unknown type");
               }
            ...
            case 3:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("FtGetDHKeyRequest", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("FtGetDHKeyRequest", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "ftGetDHKeyRequest", net.phonex.soap.entities.FtGetDHKeyRequest.class); // root
    } 

    @Override
    public String toString() {
        return "FtGetDHKeyRequest{"+"user=" + this.user+", protocolVersion=" + this.protocolVersion+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
