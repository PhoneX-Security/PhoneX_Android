...
public class UserIdentifierVectorSerializer extends Vector<net.phonex.soap.entities.UserIdentifier> implements KvmSerializable, SoapEnvelopeRegisterable { 
    ...
    public void setProperty(int index, Object value) { 
        this.add((net.phonex.soap.entities.UserIdentifier) value); 
    } 
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "UserIdentifier", net.phonex.soap.entities.UserIdentifier.class);
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "users", net.phonex.soap.entities.UserIdentifier.class);
        new UserIdentifier().register(soapEnvelope);
    }
}
