...
public class CgroupUpdateResult implements KvmSerializable, SoapEnvelopeRegisterable {
        ...
        switch (index){
            ...
            case 2:
               ...
               if (arg1 instanceof Long) {
                   this.groupId = (java.lang.Long) arg1;
               } else if (arg1 instanceof java.lang.String) {
                   final String tmpArg1 = (String) arg1;
                   try {
                       this.groupId = Long.parseLong(tmpArg1);
                   } catch (Exception e) {
                       Log.ef("CgroupUpdateResult", e, "Problem with groupId parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("CgroupUpdateResult", "Problem with groupId parsing - unknown type");
               }
            ...
            case 3:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("CgroupUpdateResult", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("CgroupUpdateResult", "Problem with version parsing - unknown type");
               }
            ...
            case 4:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("CgroupUpdateResult", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("CgroupUpdateResult", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public String toString() {
        return "CgroupUpdateResult{"+"resultCode=" + this.resultCode+", targetUser=" + this.targetUser+", groupId=" + this.groupId+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
