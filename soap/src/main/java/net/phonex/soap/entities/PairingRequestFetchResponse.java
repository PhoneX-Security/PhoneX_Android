...
public class PairingRequestFetchResponse implements KvmSerializable, SoapEnvelopeRegisterable {

    public final static String NAMESPACE = "http://phoenix.com/hr/schemas";
    protected boolean ignoreNullWrappers = false;
    protected int errCode;
    protected net.phonex.soap.entities.PairingRequestList requestList;
     ...
     * @return
     *     possible object is
     *     {@link net.phonex.soap.entities.PairingRequestList }
     *     
     */
    public net.phonex.soap.entities.PairingRequestList getRequestList() {
        return requestList;
    }
     ...
     *     
     */
    public void setRequestList(net.phonex.soap.entities.PairingRequestList value) {
    ...
    public void getPropertyInfo(int index, Hashtable arg1, PropertyInfo info) {
        ...
        switch (index){
            case 0:
                ...
                break;
            case 1:
                // type: com.phoenix.soap.beans.PairingRequestList
                info.name = "requestList";
                info.setNamespace(net.phonex.soap.ServiceConstants.NAMESPACE);
                info.type = net.phonex.soap.entities.PairingRequestList.class;
                break;
            case 2:
     ...
     public void setProperty(int index, Object arg1) {
        ...
        switch (index){
            ...
            case 1:
                // type: com.phoenix.soap.beans.PairingRequestList
                this.requestList = (net.phonex.soap.entities.PairingRequestList)arg1;
                break;
            case 2:
                // type: java.lang.Integer
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PairingRequestFetchResponse", e, "Problem with version parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PairingRequestFetchResponse", "Problem with version parsing - unknown type");
               }
            ...
            case 3:
               ...
               if (arg1 instanceof Integer) {
                   ...
                   try {
                       ...
                       Log.ef("PairingRequestFetchResponse", e, "Problem with auxVersion parsing, str=%s", tmpArg1);
                   }
               } else {
                   Log.e("PairingRequestFetchResponse", "Problem with auxVersion parsing - unknown type");
               }
    ...
    public void register(SoapSerializationEnvelope soapEnvelope) { 
        ...
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "pairingRequestFetchResponse", net.phonex.soap.entities.PairingRequestFetchResponse.class); // root
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "requestList", net.phonex.soap.entities.PairingRequestList.class); // same package
        soapEnvelope.addMapping(net.phonex.soap.ServiceConstants.NAMESPACE, "PairingRequestList", net.phonex.soap.entities.PairingRequestList.class); // package i class
        new net.phonex.soap.entities.PairingRequestList().register(soapEnvelope); // registerable 
    } 

    @Override
    public String toString() {
        return "PairingRequestFetchResponse{"+"errCode=" + this.errCode+", requestList=" + this.requestList+", version=" + this.version+", auxVersion=" + this.auxVersion+", auxJSON=" + this.auxJSON + '}';
    }
}
